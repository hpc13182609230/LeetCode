...
public class No9IsPalindrome {
    @org.junit.Test
    public void test() {
        List<Integer> arr = Lists.newArrayList(121, -121, 10, 5, 2147483647);
        for (Integer x : arr) {
            boolean y = isPalindrome(x);
            System.out.println(String.format("input= %s,output= %b", x, y));
        }
    }
